    ...
    <Layout>
      <div className="flex flex-col items-center justify-center">
        <div className="text-center mb-12 mt-8">
          <h1 className="text-4xl font-bold mb-4 text-cska-blue">
            Книга жалоб ЦСКА
          </h1>
        ...
        <div className="mt-16 bg-white rounded-lg shadow-md p-6 max-w-4xl w-full">
          <h2 className="text-2xl font-semibold mb-4">О Книге жалоб ЦСКА</h2>
          <p className="text-gray-600 mb-4">
            Мы стремимся обеспечить высочайший уровень качества обслуживания в теннисном центре ЦСКА. 
            Ваши отзывы помогают нам улучшать наши услуги и устранять возникающие проблемы.
          </p>
          <p className="text-gray-600">
            ...
            администраторами и будут приняты соответствующие меры.
          </p>
        </div>
      </div>
    </Layout>
